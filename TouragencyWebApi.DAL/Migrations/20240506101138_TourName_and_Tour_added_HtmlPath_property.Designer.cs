...
namespace TouragencyWebApi.DAL.Migrations
{
    ...
    [Migration("20240506101138_TourName_and_Tour_added_HtmlPath_property")]
    partial class TourName_and_Tour_added_HtmlPath_property
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TouragencyWebApi.DAL.Entities.Continent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TouragencyWebApi.DAL.Entities.News", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TouragencyWebApi.DAL.Entities.TourName", b =>
                {
                    ...
                    b.Property<string>("HtmlPagePathUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TouragencyWebApi.DAL.Entities.Country", b =>
                {
                    b.HasOne("TouragencyWebApi.DAL.Entities.Continent", "Continent")
                        .WithMany("Countries")
            ...
            modelBuilder.Entity("TouragencyWebApi.DAL.Entities.TouragencyEmployeeAccount", b =>
                {
                    ...
                    b.HasOne("TouragencyWebApi.DAL.Entities.TouragencyEmployee", "TouragencyEmployee")
                        .WithOne("Account")
                        .HasForeignKey("TouragencyWebApi.DAL.Entities.TouragencyEmployeeAccount", "TouragencyEmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
